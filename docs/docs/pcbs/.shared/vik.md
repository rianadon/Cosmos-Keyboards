...
- Cirque Glidepoint trackpads. You cannot use these with the Lemon microcontrollers using a standard FPC cable. However, they will work with the [Cactus Connector](cactus-connector.md) I make, because it avoids routing the RGB output to conflict with the trackpad's button outputs.
