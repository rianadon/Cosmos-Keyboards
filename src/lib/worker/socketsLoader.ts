...
export const KEY_URLS: Record<CuttleKey['type'], string> = {
  ...
  'mx-better-pcb': '/src/assets/key-mx-better-pcb.step',
  'mx-pcb': '/src/assets/key-mx-pcb.step',
  'mx-sunken': '/src/assets/key-mx-sunken.step',
  'mx-sunken-twist': '/src/assets/key-mx-sunken-twist.step',
  'choc-hotswap': '/target/key-choc-hotswap.step',
  'choc-sunken': '/src/assets/key-choc-sunken.step',
