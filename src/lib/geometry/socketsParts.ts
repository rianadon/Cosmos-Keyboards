...
export const PART_NAMES: Record<CuttleKey['type'], string> = {
  ...
  'mx-sunken': 'MX-Compatible Switches',
  'mx-sunken-twist': 'MX-Compatible Switches',
  ...
  'choc-sunken': 'Kailh Choc Switches',
...
export function socketSize(key: CuttleKey): Vector {
  ...
  if (key.type == 'mx-better') return new Vector(19.5, 19.5, 4.7)
  if (key.type == 'mx-better-pcb') return new Vector(18, 18, 6.8)
  if (key.type == 'mx-hotswap') return new Vector(18, 18, 5.85)
  if (key.type == 'mx-sunken') return new Vector(19.5, 19.5, 6.7)
  if (key.type == 'mx-sunken-twist') return new Vector(19.5, 19.5, 4.7)
  if (key.type == 'choc') return new Vector(19, 19, 2.2)
  if (key.type == 'choc-sunken') return new Vector(17.5, 16.5, 2.2)
