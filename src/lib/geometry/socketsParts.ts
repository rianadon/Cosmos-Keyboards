...
export const PART_INFO: Record<CuttleKey['type'], PartInfo> = {
  ...
  'trackball': {
    ...
    variants: {
      size: ['25mm', '34mm', '40mm', '43mm', '44mm', '45mm', '46mm', '50mm', '55mm'],
      bearings: ['Roller', 'Ball', 'BTU (7.5mm)', 'BTU (9mm)'],
      sensor: ['Joe (QMK)', 'Skree (ZMK)'],
    },
    encodeVariant: (variant: Variant) => {
      const size = ['25mm', '34mm', '40mm', '43mm', '44mm', '45mm', '46mm', '50mm', '55mm'].indexOf(variant.size)
    ...
    decodeVariant: (variant: number) => {
      ...
      return {
        size: ['25mm', '34mm', '40mm', '43mm', '44mm', '45mm', '46mm', '50mm', '55mm'][size] || '34mm',
