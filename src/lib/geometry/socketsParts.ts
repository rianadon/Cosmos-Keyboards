...
export const PART_NAMES: Record<CuttleKey['type'], string> = {
  ...
  'ec11': 'EC11 Encoders',
  'joystick-adafruit-joycon': 'Adafruit Mini Thumbsticks (Joycon style, #5628)',
...
export function socketSize(key: CuttleKey): Vector {
  ...
  if (key.type == 'joystick-adafruit-joycon') return new Vector(24.25, 24.4, 3.5)
...
export function partBottom(sw: CuttleKey['type'] | undefined): [number, number, number][][] {
  ...
  if (sw == 'joystick-adafruit-joycon') {
