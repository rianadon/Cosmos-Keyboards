...
export function socketSize(key: CuttleKey): Vector {
  ...
  if (key.type == 'mx-better') return new Vector(19.5, 19.5, 6.7)
  ...
  if (key.type == 'mx-sunken-twist') return new Vector(19.5, 19.5, 6.7)
  if (key.type == 'choc') return new Vector(19, 19, 3.9)
