...
export declare class GeomConvert_CompCurveToBSplineCurve {
  Add_1(NewCurve: Handle_Geom_BoundedCurve, Tolerance: Standard_Real, After: Standard_Boolean, WithRatio: Standard_Boolean, MinM: Graphic3d_ZLayerId): Standard_Boolean;
  BSplineCurve(): Handle_Geom_BSplineCurve;
  Clear(): void;
  delete(): void;
}
  ...
  export declare class GeomConvert_CompCurveToBSplineCurve_2 extends GeomConvert_CompCurveToBSplineCurve {
    constructor(BasisCurve: Handle_Geom_BoundedCurve, Parameterisation: Convert_ParameterisationType);
  }
...
export declare class Geom_BezierSurface extends Geom_BoundedSurface {
  ExchangeUV(): void;
  Increase(UDeg: Graphic3d_ZLayerId, VDeg: Graphic3d_ZLayerId): void;
  InsertPoleColAfter_1(VIndex: Graphic3d_ZLayerId, CPoles: TColgp_Array1OfPnt): void;
  InsertPoleColAfter_2(VIndex: Graphic3d_ZLayerId, CPoles: TColgp_Array1OfPnt, CPoleWeights: IntTools_CArray1OfReal): void;
  InsertPoleColBefore_1(VIndex: Graphic3d_ZLayerId, CPoles: TColgp_Array1OfPnt): void;
  InsertPoleColBefore_2(VIndex: Graphic3d_ZLayerId, CPoles: TColgp_Array1OfPnt, CPoleWeights: IntTools_CArray1OfReal): void;
  InsertPoleRowAfter_1(UIndex: Graphic3d_ZLayerId, CPoles: TColgp_Array1OfPnt): void;
  InsertPoleRowAfter_2(UIndex: Graphic3d_ZLayerId, CPoles: TColgp_Array1OfPnt, CPoleWeights: IntTools_CArray1OfReal): void;
  InsertPoleRowBefore_1(UIndex: Graphic3d_ZLayerId, CPoles: TColgp_Array1OfPnt): void;
  InsertPoleRowBefore_2(UIndex: Graphic3d_ZLayerId, CPoles: TColgp_Array1OfPnt, CPoleWeights: IntTools_CArray1OfReal): void;
  RemovePoleCol(VIndex: Graphic3d_ZLayerId): void;
  RemovePoleRow(UIndex: Graphic3d_ZLayerId): void;
  ...
  SetPoleRow_1(UIndex: Graphic3d_ZLayerId, CPoles: TColgp_Array1OfPnt): void;
  SetPoleRow_2(UIndex: Graphic3d_ZLayerId, CPoles: TColgp_Array1OfPnt, CPoleWeights: IntTools_CArray1OfReal): void;
...
export declare class GeomFill_BezierCurves {
  Init_1(C1: Handle_Geom_BezierCurve, C2: Handle_Geom_BezierCurve, C3: Handle_Geom_BezierCurve, C4: Handle_Geom_BezierCurve, Type: GeomFill_FillingStyle): void;
  Init_2(C1: Handle_Geom_BezierCurve, C2: Handle_Geom_BezierCurve, C3: Handle_Geom_BezierCurve, Type: GeomFill_FillingStyle): void;
  Init_3(C1: Handle_Geom_BezierCurve, C2: Handle_Geom_BezierCurve, Type: GeomFill_FillingStyle): void;
  Surface(): Handle_Geom_BezierSurface;
  delete(): void;
}
  ...
  export declare class GeomFill_BezierCurves_2 extends GeomFill_BezierCurves {
    constructor(C1: Handle_Geom_BezierCurve, C2: Handle_Geom_BezierCurve, C3: Handle_Geom_BezierCurve, C4: Handle_Geom_BezierCurve, Type: GeomFill_FillingStyle);
  }

  export declare class GeomFill_BezierCurves_3 extends GeomFill_BezierCurves {
    constructor(C1: Handle_Geom_BezierCurve, C2: Handle_Geom_BezierCurve, C3: Handle_Geom_BezierCurve, Type: GeomFill_FillingStyle);
  }

  export declare class GeomFill_BezierCurves_4 extends GeomFill_BezierCurves {
    constructor(C1: Handle_Geom_BezierCurve, C2: Handle_Geom_BezierCurve, Type: GeomFill_FillingStyle);
  }
