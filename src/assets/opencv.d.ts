...
/** function */
export var _llvm_maxnum_f64: any;

/** function */
export var _llvm_round_f64: any;
...
/** function */
export var dynCall_iiiiffii: any;
...
/** function */
export var dynCall_iiiiiiiiif: any;

/** function */
export var dynCall_iiiiiiiiifd: any;

/** function */
export var dynCall_iiiiiiiiifdi: any;

/** function */
export var dynCall_iiiiiiiiifdii: any;

/** function */
export var dynCall_iiiiiiiiii: any;

/** function */
export var dynCall_iiiiiiiiiif: any;

/** function */
export var dynCall_iiiiiiiiiifd: any;

/** function */
export var dynCall_iiiiiiiiiifdi: any;

/** function */
export var dynCall_iiiiiiiiiifdii: any;

/** function */
export var dynCall_iiiiiiiiiii: any;
...
/** function */
export var dynCall_vifiiii: any;

/** function */
export var dynCall_vifiiiii: any;
...
/** function */
export var dynCall_viiiffii: any;
...
/** function */
export var dynCall_viiiiiiiiiiii: any;
...
/** function */
export var estimateAffine2D1: any;
...
/** function */
export var findHomography1: any;

/** function */
export var findTransformECC: any;

/** function */
export var findTransformECC1: any;
...
/** function */
export var solvePnP: any;

/** function */
export var solvePnPRansac: any;

/** function */
export var solvePnPRansac1: any;

/** function */
export var solvePnPRefineLM: any;
...
/** function */
export var detectMarkers: any;

/** function */
export var drawAxis: any;

/** function */
export var drawDetectedCornersCharuco: any;

/** function */
export var drawDetectedMarkers: any;

/** function */
export var estimatePoseBoard: any;

/** function */
export var estimatePoseCharucoBoard: any;

/** function */
export var estimatePoseSingleMarkers: any;

/** function */
export var interpolateCornersCharuco: any;
...
/** function */
export var aruco_Board: any;

/** function */
export var aruco_CharucoBoard: any;

/** function */
export var aruco_DetectorParameters: any;

/** function */
export var aruco_Dictionary: any;

/** function */
export var aruco_GridBoard: any;

/** function */
export var dnn_Net: any;

/** function */
export var segmentation_IntelligentScissorsMB: any;
...
export var CALIB_ROBOT_WORLD_HAND_EYE_LI: number;
export var CALIB_ROBOT_WORLD_HAND_EYE_SHAH: number;
...
export var CCL_BBDT: number;
export var CCL_BOLELLI: number;
export var CCL_DEFAULT: number;
export var CCL_GRANA: number;
export var CCL_SAUF: number;
export var CCL_SPAGHETTI: number;
...
export var COLORMAP_DEEPGREEN: number;
...
export var INTER_NEAREST_EXACT: number;
...
export var LOCAL_OPTIM_GC: number;
export var LOCAL_OPTIM_INNER_AND_ITER_LO: number;
export var LOCAL_OPTIM_INNER_LO: number;
export var LOCAL_OPTIM_NULL: number;
export var LOCAL_OPTIM_SIGMA: number;
...
export var NEIGH_FLANN_KNN: number;
export var NEIGH_FLANN_RADIUS: number;
export var NEIGH_GRID: number;
...
export var QUAT_ASSUME_NOT_UNIT: number;
export var QUAT_ASSUME_UNIT: number;
export var QuatEnum_EULER_ANGLES_MAX_VALUE: number;
export var QuatEnum_EXT_XYX: number;
export var QuatEnum_EXT_XYZ: number;
export var QuatEnum_EXT_XZX: number;
export var QuatEnum_EXT_XZY: number;
export var QuatEnum_EXT_YXY: number;
export var QuatEnum_EXT_YXZ: number;
export var QuatEnum_EXT_YZX: number;
export var QuatEnum_EXT_YZY: number;
export var QuatEnum_EXT_ZXY: number;
export var QuatEnum_EXT_ZXZ: number;
export var QuatEnum_EXT_ZYX: number;
export var QuatEnum_EXT_ZYZ: number;
export var QuatEnum_INT_XYX: number;
export var QuatEnum_INT_XYZ: number;
export var QuatEnum_INT_XZX: number;
export var QuatEnum_INT_XZY: number;
export var QuatEnum_INT_YXY: number;
export var QuatEnum_INT_YXZ: number;
export var QuatEnum_INT_YZX: number;
export var QuatEnum_INT_YZY: number;
export var QuatEnum_INT_ZXY: number;
export var QuatEnum_INT_ZXZ: number;
export var QuatEnum_INT_ZYX: number;
export var QuatEnum_INT_ZYZ: number;
...
export var SAMPLING_NAPSAC: number;
export var SAMPLING_PROGRESSIVE_NAPSAC: number;
export var SAMPLING_PROSAC: number;
export var SAMPLING_UNIFORM: number;
export var SCORE_METHOD_LMEDS: number;
export var SCORE_METHOD_MAGSAC: number;
export var SCORE_METHOD_MSAC: number;
export var SCORE_METHOD_RANSAC: number;
...
export var SOLVEPNP_SQPNP: number;
...
export var USAC_ACCURATE: number;
export var USAC_DEFAULT: number;
export var USAC_FAST: number;
export var USAC_FM_8PTS: number;
export var USAC_MAGSAC: number;
export var USAC_PARALLEL: number;
export var USAC_PROSAC: number;
...
export var CORNER_REFINE_APRILTAG: number;
export var CORNER_REFINE_CONTOUR: number;
export var CORNER_REFINE_NONE: number;
export var CORNER_REFINE_SUBPIX: number;
export var DICT_4X4_100: number;
export var DICT_4X4_1000: number;
export var DICT_4X4_250: number;
export var DICT_4X4_50: number;
export var DICT_5X5_100: number;
export var DICT_5X5_1000: number;
export var DICT_5X5_250: number;
export var DICT_5X5_50: number;
export var DICT_6X6_100: number;
export var DICT_6X6_1000: number;
export var DICT_6X6_250: number;
export var DICT_6X6_50: number;
export var DICT_7X7_100: number;
export var DICT_7X7_1000: number;
export var DICT_7X7_250: number;
export var DICT_7X7_50: number;
export var DICT_APRILTAG_16h5: number;
export var DICT_APRILTAG_25h9: number;
export var DICT_APRILTAG_36h10: number;
export var DICT_APRILTAG_36h11: number;
export var DICT_ARUCO_ORIGINAL: number;
...
export var TrackerSamplerCSC_MODE_DETECT: number;
export var TrackerSamplerCSC_MODE_INIT_NEG: number;
export var TrackerSamplerCSC_MODE_INIT_POS: number;
export var TrackerSamplerCSC_MODE_TRACK_NEG: number;
export var TrackerSamplerCSC_MODE_TRACK_POS: number;
...
export var DNN_TARGET_HDDL: number;
...
export var ENUM_LOG_LEVEL_FORCE_INT: number;
export var LOG_LEVEL_DEBUG: number;
export var LOG_LEVEL_ERROR: number;
export var LOG_LEVEL_FATAL: number;
export var LOG_LEVEL_INFO: number;
export var LOG_LEVEL_SILENT: number;
export var LOG_LEVEL_VERBOSE: number;
export var LOG_LEVEL_WARNING: number;
