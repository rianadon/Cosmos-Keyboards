/** My attempt on not shipping an entire code editor with the generator.

    I've commented out stuff that I don't *think* I need,
    either because it's not needed or already included
  */
